...
from app.schemas.messages import MessageSchema, MessageReadSchema
...
@user_router.get(path="/my-incoming-messages", response_model=List[MessageSchema])
...
@user_router.get(path="/my-incoming-messages/{message_id}", response_model=MessageReadSchema)
...
async def run_test_task():
    send_message_to_email.delay("Вася")
